...
from p1 import clean_weather
from p1 import clean_stadiumtype
from p1 import clean_play_df
...
ConfusionMatrixDisplay.from_estimator(new1, X, y)

joblib.dump(new1, 'logistic_regression_model.pkl')
